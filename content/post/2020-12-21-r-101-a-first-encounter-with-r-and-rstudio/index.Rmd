...
INSERT IMAGE
```{r , eval = FALSE, rstudio.logo, echo=FALSE, fig.cap = "The RStudio logo"}
knitr::include_graphics(here::here("images/RStudio_logo.png"))
```
...
```{r , eval = F, rstudio.open, echo=FALSE , fig.cap = "RStudio when first opened."}
x <- here::here("images/RStudio_1st_view-800x600.png")
...
INSERT IMASGE
```{r, eval = F, rstudio.console, echo=FALSE, fig.cap = "RStudio's console and script editor."}
x <- here::here("images/RStudio_console_vs_script_editor-800x600.png")
knitr::include_graphics(x)
```
